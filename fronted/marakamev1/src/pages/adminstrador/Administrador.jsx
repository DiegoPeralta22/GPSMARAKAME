...
export default function Administrador() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#f3f4f6", fontFamily:"system-ui,sans-serif" }}>
      {/* Header */}
      <div style={{ background:"#0b5d5b", color:"#fff", padding:"0 32px", display:"flex", alignItems:"center", justifyContent:"space-between", height:64, flexShrink:0 }}>
      ...
      <div style={{ maxWidth:1100, margin:"0 auto", padding:28 }}>
        <h2 style={{ fontSize:22, fontWeight:800, color:"#111827", margin:"0 0 6px" }}>Panel de Administración</h2>
              ...
              {recibos.map((r, i) => (
                <div key={i} style={{ background:"#fff", borderRadius:12, border:"1px solid #e5e7eb", padding:20, boxShadow:"0 1px 4px rgba(0,0,0,.06)" }}>
                  ...
                  <div style={{ fontSize:11, color:"#9ca3af", marginBottom:14 }}>
                    Creado: {fmt(r.fecha)} · Por: {r.nombre_creador || "—"}
                  </div>
                      ...
                      <tr key={i} style={{ borderBottom:"1px solid #f3f4f6" }}>
                        ...
                        <td style={{ padding:"12px 14px" }}>
                          <span style={{ fontSize:11,fontWeight:700,padding:"3px 10px",borderRadius:20,
                            background:isAp?"#e6f4f3":"#fff1f2", color:isAp?"#0b5d5b":"#ef4444" }}>
        ...
        <>
          ...
          <div style={{ position:"fixed",top:"50%",left:"50%",transform:"translate(-50%,-50%)",width:"min(700px,95vw)",maxHeight:"90vh",overflowY:"auto",background:"#fff",borderRadius:14,zIndex:901,padding:28 }}>
            ...
            <div style={{ display:"flex", gap:10, marginTop:16 }}>
              <button onClick={() => setDetalle(null)} style={{ flex:1, padding:12, background:"#f3f4f6", color:"#374151", border:"none", borderRadius:8, fontSize:13, fontWeight:600, cursor:"pointer" }}>
                Cerrar
              </button>
